 ...
 * @return Active cue slot.
 * @pre `cues` and `cue` are valid and the cue pool has sufficient authored capacity.
 * @pre The cue activation callback does not release/reuse the reserved slot.
 */
