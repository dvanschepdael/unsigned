...
#ifndef UNSIGNED_SYSTEM_RUNTIME_H
#define UNSIGNED_SYSTEM_RUNTIME_H
...
/** Run ngdevkit main() for USER 1/2.
 * @pre `definition` and `definition->input` are valid for the full USER entry.
 * @pre `coin_sound_command` is `U_AUDIO_COMMAND_NONE` or a game command in 4..127.
 */
