...
static bool level_npc_is_in_active_region(const UNpc *npc, const UViewport *viewport) {
    ...
    return unsigned_viewport_intersects_world_rect(viewport, world_left, world_top, world_right - world_left, world_bottom - world_top,
                                                   UNSIGNED_NPC_ACTIVE_MARGIN_X, UNSIGNED_NPC_ACTIVE_MARGIN_Y);
}
